...
var Form = function (props) {
        ...
        if (dependencies === null || dependencies === void 0 ? void 0 : dependencies.length) {
            var subscription_1 = methods.watch(function (formValues, _a) {
                ...
                if (type === 'change' && _name) {
                    ...
                    findDependencies.forEach(function (dependency) { var _a; return (_a = dependency.callback) === null || _a === void 0 ? void 0 : _a.call(dependency, formValues, methods, { index: index_1 }); });
                }
            });
    ...
    return (React.createElement(react_hook_form_1.FormProvider, __assign({}, methods),
        React.createElement(FormOptions_1.FormOptionsProvider, { showErrorText: showErrorText },
            React.createElement(ValidationsContext_1.ValidationsProvider, { validations: validations },
                React.createElement("form", __assign({ id: formId, onSubmit: methods.handleSubmit(onSubmit !== null && onSubmit !== void 0 ? onSubmit : (function () { })) }, restFormProps, { style: __assign({ display: 'flex', flexDirection: 'column', gap: gap }, restFormProps === null || restFormProps === void 0 ? void 0 : restFormProps.style) }), children)))));
};
